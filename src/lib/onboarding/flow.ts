...
/** Short labels for showing answers on the profile page. */
export const STEP_LABELS: Record<string, string> = {
  ...
  study: "Studying",
  year: "Year & graduation",
  hs_year: "Grade",
  grad_date: "Graduated",
  hs_after: "After high school",
  grad_status: "Right now",
  current_role: "Current role",
  industry: "Industry",
  years_experience: "Years of experience",
  desired_role: "Next role",
  desired_career: "Target career",
  stuck: "What feels stuck",
  constraints: "Constraints",
  timeline: "Timeline",
  venture_has_idea: "Business idea",
  venture_idea: "The idea",
  venture_industry: "Venture industry",
  venture_offering: "Product or service",
  venture_stage: "Stage",
  venture_customer: "Target customer",
  venture_capital: "Starting budget",
  venture_problems: "Problems noticed",
  skills: "Skills",
  interests: "Interests",
  career_certainty: "Know what you want?",
  career_interests: "Career interests",
  vision: "Five-year vision",
  industries: "Industries",
  location: "Location",
  priorities: "What matters most",
  gpa: "GPA",
  grad_school: "Grad school",
  entrepreneurship: "Starting something",
  companies: "Companies you admire",
  learn: "Skills to learn",
  salary_goal: "Salary goal",
